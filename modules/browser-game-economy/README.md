...
The economy boundary owns currency definitions, atomic wallet ledgers, faucets and sinks, vendor offers, marketplace listings, fee calculation, idempotent transfers, settlement, cancellation, and transaction amount limits. Vendors and listings may be shared or scoped to a tenant/team, and scoped marketplace operations fail closed outside that context. Item movement remains an asset-reference contract so this package does not duplicate the Items module's private tables.
